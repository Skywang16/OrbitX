...
export function useShortcuts() {
  ...
  const removeShortcut = (category: ShortcutCategory, index: number) =>
    store.removeShortcut(category, index);
  ...
  const searchShortcuts = (options: ShortcutSearchOptions) =>
    store.searchShortcuts(options);

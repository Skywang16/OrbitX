    ...
    <div class="conflict-dialog">
      ...
      <div class="dialog-content">
        <p class="conflict-description">
          检测到 {{ conflicts.length }} 个快捷键冲突，请选择要保留的快捷键：
        </p>
        ...
        >
          <div class="conflict-header">
            <h4>冲突组合: <code>{{ conflict.key_combination }}</code></h4>
          </div>
...
const canResolve = computed(() => {
  return props.conflicts.every((_, index) => 
    selectedShortcuts.value[index] !== undefined
  );
});

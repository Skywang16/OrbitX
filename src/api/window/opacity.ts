 ...
 */
export const setWindowOpacity = async (opacity: number): Promise<void> => {
 ...
 * 重置窗口透明度为完全不透明
 */
export const resetWindowOpacity = async (): Promise<void> => {
 ...
 * @returns 取消监听的函数
 */
export const onOpacityChanged = async (callback: (opacity: number) => void): Promise<UnlistenFn> => {

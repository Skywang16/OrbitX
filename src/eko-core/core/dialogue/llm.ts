import { LanguageModelV2FilePart, LanguageModelV2StreamPart, LanguageModelV2ToolResultPart } from '@ai-sdk/provider'
import {
...
export function convertToolResults(toolResults: LanguageModelV2ToolResultPart[]): EkoMessageToolPart[] {

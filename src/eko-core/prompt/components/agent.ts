...
- High-Risk Path Guard: If the current or target directory appears to be overly broad or system-managed (e.g., '/', '/Users', '/Users/<name>', '/home', '/var', '/etc', '/Library', OS media/library folders like 'Music Library.musiclibrary'), do NOT enumerate or operate broadly without explicit user approval. The UI will require an explicit confirmation or a narrower project subpath selection before proceeding.

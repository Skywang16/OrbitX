...
export const testScenarios: TestScenario[] = [
  {
    ...
    steps: [
      ...
      '4. Look for terminal_context_set_active_pane API call',
    ],
    expectedResults: [
      'New terminal tab appears',
      'Terminal is marked as active',
      'terminal_context_set_active_pane API call is made with correct paneId',
  ...
  },
  {
    ...
    steps: [
      ...
      '4. Check for terminal_context_set_active_pane calls',
    ],
    expectedResults: [
      'Each tab switch triggers terminal_context_set_active_pane call',
